...
class ModelBase extends Model
{
     ...
     * 若不需要分页 $paginate 设置为 false
     */
    final protected function getListApi($where = [], $field = true, $order = '', $paginate = 0)
    {


//        $pagecon=['page'=>input('page')];
        ...
        if (false === $paginate) {
            ...
            $list = $query_temp->paginate(input('list_rows', empty($paginate) ? DB_LIST_ROWS : $paginate), false, input());
        }
